...
const BotName = 'IM BOT'; 
const aktif = 'Kapan bot aktif';
const vcard = 'BEGIN:VCARD\n' // metadata of the contact card
            + 'VERSION:3.0\n' 
            + 'FN:Rapid\n' // Nama kamu
            + 'ORG:IM BOT;\n' // Nama bot
            + 'TEL;type=CELL;type=VOICE;waid=6285810753481:+62 858-1075-3481\n' //Nomor whatsapp kamu
            + 'END:VCARD'
const
{
WAConnection,
...
if (text.includes('.chatprank')){
    ...
    const nama = gh.split("/")[0];
    const tgl = gh.split("/")[1];
 let hasil = `${nama}͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏${tgl}`;
    conn.sendMessage(id, hasil ,MessageType.text, { quoted: m } );
}
